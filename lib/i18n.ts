...
export const translations = {
  ...
  en: {
    ...
    tabAIPlan: 'AI Initial Plan',
    aiPlanEmpty: 'No AI plan yet',
    aiPlanEmptyDesc: 'When voting reaches 100, the AI mini-model auto-launches to draft an initial implementation plan.',
    aiPlanGenerating: 'AI mini-model is drafting the plan. Please wait...',
    aiPlanDone: 'AI mini-model has drafted the initial plan',
    ...
    // Vote (Launch Vote)
    voteTitle: 'Launch Vote',
    voteDesc: 'Support this idea. At 100 votes, the AI mini-model auto-launches to draft an initial plan',
    voteButton: '👍 Agree & Launch',
    votedButton: '✅ Voted',
    ...
    voteLaunchedDesc: 'Reached 100 votes. The AI mini-model has auto-launched',
    voteGenerating: 'AI mini-model is drafting the plan. Please wait...',
    voteGenerateDone: 'AI mini-model has drafted the initial plan',
    voteError: 'Vote failed. Please retry',
